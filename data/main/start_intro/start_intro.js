export const start_intro = [
    ...
    },
    {
      ...
      text: 'По результатам консультации врач-кинезитерапевт назначает индивидуальную программу лечения и профилактики, учитывая особенности каждого пациента, а также сопутствующие заболевания',
